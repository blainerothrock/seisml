...
from seisml.utility.parser import construct_data_parser
from seisml.utility.utils import save_file, parallel_process
...
def load_data(directory, label, target_directory):
    ...
    earthquake_files = [{
        ...
        'label': label
        } for x in os.listdir(directory) if '.SAC' or '.sac' in x
    ]
